...
# Select 60% rows of cluster 1 as test data
  ...
  train_id1 = c(sample(yes_people , size = trunc(0.40 * length(yes_people ))),sample(no_people , size = trunc(0.40 * length(no_people ))))
...
# Select 60% rows of cluster 2 as test data
  ...
  train_id2 = c(sample(yes_people , size = trunc(0.40 * length(yes_people ))),sample(no_people , size = trunc(0.40 * length(no_people ))))
...
# Select 60% rows of cluster 5 as test data
  ...
  train_id5 = c(sample(yes_people , size = trunc(0.40 * length(yes_people ))),sample(no_people , size = trunc(0.40 * length(no_people ))))
